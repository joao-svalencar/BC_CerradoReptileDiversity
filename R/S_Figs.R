...
###########################################################################
# Figure 1 - NMDS Cerrado centrality --------------------------------------
###########################################################################

nmds_coordinates <- as.data.frame(nmds_res$points) # object nmds_res from D_analyses line 62
...
###########################################################################
# Figure 6 - Endemism levels through time ---------------------------------
###########################################################################

list_cerrado <- list_br[list_br$cerrado_sp=="yes",] # object list_br from R_data line xxx

table(list_cerrado$order)
table(list_cerrado$cerrado_endemic, list_cerrado$order)


sppRich # object sppRich from R_data line xxx
